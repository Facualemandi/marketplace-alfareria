...
const Data = ({ productInTheCart }) => {
  ...
  return (
    <form id="formulario" class="formulario"  onSubmit={onSubmit}>
      <h1>Último paso</h1>
      <div class="box-input">
        <input name="nombre"  type="text" value={form.name} onChange={onChangeValue} required />
        <label>Nombre</label>
      </div>
      <div class="box-input">
        <input name="apellido" type="text" value={form.apellido} onChange={onChangeValue} required />
